...
HD_PWD='C:/verilog_lab/Digital_test/Digital_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digital_test.tcl

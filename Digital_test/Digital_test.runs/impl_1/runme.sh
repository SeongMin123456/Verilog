...
HD_PWD='C:/verilog_lab/Digital_test/Digital_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source digital_test.tcl -notrace

...
HD_PWD='C:/verilog_lab/my_dsp/my_dsp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_dsp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_dsp.tcl

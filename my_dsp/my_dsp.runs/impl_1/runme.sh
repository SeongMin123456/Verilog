...
HD_PWD='C:/verilog_lab/my_dsp/my_dsp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_dsp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_dsp.tcl -notrace

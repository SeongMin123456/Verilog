...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SPI_Master is
  ...
  signal \RD_cnt[3]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \RD_cnt[3]_i_4\ : label is "soft_lutpair1";
...
\RD_cnt[3]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (

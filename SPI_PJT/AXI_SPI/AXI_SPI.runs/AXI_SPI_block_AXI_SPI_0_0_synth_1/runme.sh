...
HD_PWD='C:/verilog_lab/SPI_PJT/AXI_SPI/AXI_SPI.runs/AXI_SPI_block_AXI_SPI_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_SPI_block_AXI_SPI_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_SPI_block_AXI_SPI_0_0.tcl

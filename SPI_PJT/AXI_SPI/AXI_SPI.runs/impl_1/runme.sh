...
HD_PWD='C:/verilog_lab/SPI_PJT/AXI_SPI/AXI_SPI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_SPI_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI_SPI_block_wrapper.tcl -notrace

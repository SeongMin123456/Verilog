...
-- Date        : Mon Feb 10 17:32:25 2025
-- Host        : COMSYS01 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/verilog_lab/SPI_PJT/AXI_SPI/AXI_SPI.gen/sources_1/bd/AXI_SPI_block/ip/AXI_SPI_block_SPI_Master_0_0/AXI_SPI_block_SPI_Master_0_0_sim_netlist.vhdl
...
entity AXI_SPI_block_SPI_Master_0_0_SPI_Master is
  port (
    RST : in STD_LOGIC;
    CLK : in STD_LOGIC;
  ...
  attribute IDLE of AXI_SPI_block_SPI_Master_0_0_SPI_Master : entity is "3'b000";
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of AXI_SPI_block_SPI_Master_0_0_SPI_Master : entity is "SPI_Master";
  attribute R_DONE : string;
  attribute R_DONE of AXI_SPI_block_SPI_Master_0_0_SPI_Master : entity is "3'b111";
  attribute R_LOAD : string;
  attribute R_LOAD of AXI_SPI_block_SPI_Master_0_0_SPI_Master : entity is "3'b100";
  attribute R_START : string;
  attribute R_START of AXI_SPI_block_SPI_Master_0_0_SPI_Master : entity is "3'b011";
  attribute W_DONE : string;
  attribute W_DONE of AXI_SPI_block_SPI_Master_0_0_SPI_Master : entity is "3'b010";
  attribute W_START : string;
  attribute W_START of AXI_SPI_block_SPI_Master_0_0_SPI_Master : entity is "3'b001";
  attribute keep_hierarchy : string;
  attribute keep_hierarchy of AXI_SPI_block_SPI_Master_0_0_SPI_Master : entity is "soft";
end AXI_SPI_block_SPI_Master_0_0_SPI_Master;

architecture STRUCTURE of AXI_SPI_block_SPI_Master_0_0_SPI_Master is
  ...
  signal \seq_done_cnt_reg_n_0_[0]\ : STD_LOGIC;
  signal \seq_done_cnt_reg_n_0_[1]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \curr_state[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \curr_state[2]_i_1\ : label is "soft_lutpair1";
...
CSN_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"08000008000000FF"
        ...
        port map (
      I0 => \^sclk\,
      I1 => \seq_done_cnt_reg_n_0_[1]\,
      I2 => \seq_done_cnt_reg_n_0_[0]\,
      I3 => curr_state(2),
      I4 => curr_state(0),
      I5 => curr_state(1),
      O => CSN_i_2_n_0
...
\RD_cnt[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4341"
    )
        port map (
      ...
      I1 => curr_state(0),
      I2 => curr_state(1),
      I3 => \RD_cnt[0]_i_3_n_0\,
      O => \RD_cnt[0]_i_1_n_0\
    );
\RD_cnt[0]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\RD_cnt[0]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
...
\R_data[7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => \RD_cnt[0]_i_1_n_0\,
      I1 => curr_state(2),
      O => \R_data[7]_i_1_n_0\
    );
...
R_temp_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FAF3FFF30A000000"
    )
        port map (
      I0 => MISO,
      I1 => CMD(1),
...
R_temp_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\next_state_reg[0]__0_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\next_state_reg[0]__0_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
\seq_done_cnt[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4F80"
        ...
        port map (
      I0 => \seq_done_cnt_reg_n_0_[0]\,
      I1 => curr_state(1),
      I2 => \seq_done_cnt[1]_i_2_n_0\,
      I3 => \seq_done_cnt_reg_n_0_[1]\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity AXI_SPI_block_SPI_Master_0_0 is
  port (
    RST : in STD_LOGIC;
    CLK : in STD_LOGIC;
    CMD : in STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  attribute NotValidForBitStream of AXI_SPI_block_SPI_Master_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of AXI_SPI_block_SPI_Master_0_0 : entity is "AXI_SPI_block_SPI_Master_0_0,SPI_Master,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of AXI_SPI_block_SPI_Master_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of AXI_SPI_block_SPI_Master_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of AXI_SPI_block_SPI_Master_0_0 : entity is "SPI_Master,Vivado 2023.2";
end AXI_SPI_block_SPI_Master_0_0;

architecture STRUCTURE of AXI_SPI_block_SPI_Master_0_0 is
  attribute IDLE : string;
...
begin
inst: entity work.AXI_SPI_block_SPI_Master_0_0_SPI_Master
     port map (

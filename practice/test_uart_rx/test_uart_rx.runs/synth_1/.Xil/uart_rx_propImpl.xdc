set_property SRC_FILE_INFO {cfile:C:/verilog_lab/practice/test_uart_rx/test_uart_rx.srcs/constrs_1/new/uart_rx.xdc rfile:../../../test_uart_rx.srcs/constrs_1/new/uart_rx.xdc id:1} [current_design]
set_property SRC_FILE_INFO {cfile:C:/verilog_lab/practice/test_uart_rx/test_uart_rx.srcs/constrs_1/new/debug.xdc rfile:../../../test_uart_rx.srcs/constrs_1/new/debug.xdc id:2} [current_design]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {digit_1[0]} {digit_1[1]} {digit_1[2]} {digit_1[3]}]]
...
connect_debug_port u_ila_0/probe1 [get_nets [list {digit_10[0]} {digit_10[1]} {digit_10[2]} {digit_10[3]}]]
...
connect_debug_port u_ila_0/probe2 [get_nets [list {rx_data[0]} {rx_data[1]} {rx_data[2]} {rx_data[3]} {rx_data[4]} {rx_data[5]} {rx_data[6]} {rx_data[7]}]]
...
connect_debug_port u_ila_0/probe3 [get_nets [list {sampling[0]} {sampling[1]} {sampling[2]} {sampling[3]}]]
...
connect_debug_port u_ila_0/probe5 [get_nets [list {baud_cnt[0]} {baud_cnt[1]} {baud_cnt[2]} {baud_cnt[3]}]]
...
connect_debug_port u_ila_0/probe6 [get_nets [list {curr_state[0]} {curr_state[1]}]]

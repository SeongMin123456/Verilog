...
HD_PWD='C:/verilog_lab/practice/practice_stopwatch/practice_stopwatch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log practice_stopwatch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source practice_stopwatch.tcl -notrace

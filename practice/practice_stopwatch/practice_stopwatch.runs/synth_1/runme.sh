...
HD_PWD='C:/verilog_lab/practice/practice_stopwatch/practice_stopwatch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log practice_stopwatch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source practice_stopwatch.tcl

...
HD_PWD='C:/verilog_lab/practice/test_traffic/test_traffic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source traffic_test.tcl

...
HD_PWD='C:/verilog_lab/practice/test_traffic/test_traffic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source traffic_test.tcl -notrace

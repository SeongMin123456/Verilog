...
HD_PWD='C:/verilog_lab/practice/test_stopwatch2/test_stopwatch2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_stopwatch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_stopwatch.tcl -notrace

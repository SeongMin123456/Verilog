...
HD_PWD='C:/verilog_lab/practice/test_stopwatch2/test_stopwatch2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_stopwatch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_stopwatch.tcl

...
HD_PWD='C:/verilog_lab/practice/test_security/test_security.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log practice_security.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source practice_security.tcl

...
HD_PWD='C:/verilog_lab/practice/test_security/test_security.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log practice_security.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source practice_security.tcl -notrace

...
HD_PWD='C:/verilog_lab/my_serdes/my_serdes.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_P2S.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_P2S.tcl

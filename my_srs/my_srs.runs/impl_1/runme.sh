...
HD_PWD='C:/verilog_lab/my_srs/my_srs.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_srs.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_srs.tcl -notrace

...
HD_PWD='C:/verilog_lab/my_srs/my_srs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_srs.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_srs.tcl

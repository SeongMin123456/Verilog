...
/* Definitions for peripheral AXI_GPIO_DIS */
#define XPAR_AXI_GPIO_DIS_COMPATIBLE xlnx,axi-gpio-2.0
#define XPAR_AXI_GPIO_DIS_BASEADDR 0x41200000
#define XPAR_AXI_GPIO_DIS_HIGHADDR 0x4120ffff
#define XPAR_AXI_GPIO_DIS_INTERRUPT_PRESENT 0x0
#define XPAR_AXI_GPIO_DIS_IS_DUAL 0x0
#define XPAR_AXI_GPIO_DIS_GPIO_WIDTH 0x2

/* Canonical definitions for peripheral AXI_GPIO_DIS */

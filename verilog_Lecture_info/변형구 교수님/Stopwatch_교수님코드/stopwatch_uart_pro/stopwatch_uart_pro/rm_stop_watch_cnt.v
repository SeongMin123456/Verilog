...
rm_pls_cnt100 u_m_cnt
( 
.rst       	(rst      	),  // USER_DIO1 <L19>
.clk       	(clk      	),  // 125MHz
//                    
.uart_set  	(uart_set  	),  // High Active Clear
.setv    	(rmin	  	),  // High Active Count
//                    
...
rm_pls_cnt60 u_s_cnt
( 
.rst       	(rst      	),  // USER_DIO1 <L19>
.clk       	(clk      	),  // 125MHz
//                    
.uart_set  	(uart_set  	),  // High Active Clear
.setv    	(rsec	  	),  // High Active Count
//                    
.clr       	(clr_pls   	),  // High Active Clear
.cnt_en    	(cnt_ens  	),  // High Active Count
//                    
...
rm_pls_cnt100 u_us_cnt
( 
.rst       	(rst      	),  // USER_DIO1 <L19>
.clk       	(clk      	),  // 125MHz
//                    
.uart_set  	(uart_set  	),  // High Active Clear
.setv    	(rusec	  	),  // High Active Count
//                    
.clr       	(clr_pls   	),  // High Active Clear
.cnt_en    	(cnt_ens  	),  // High Active Count
//                    

...
HD_PWD='C:/verilog_lab/my_stopwatch/my_stopwatch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_stopwatch_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_stopwatch_top.tcl -notrace

...
HD_PWD='C:/verilog_lab/my_stopwatch/my_stopwatch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_stopwatch_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_stopwatch_top.tcl

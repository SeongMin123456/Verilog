...
HD_PWD='C:/verilog_lab/my_multiplexer/my_multiplexer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_multiplexer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_multiplexer.tcl

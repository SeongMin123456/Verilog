...
HD_PWD='C:/verilog_lab/Disital_test3_Stopwatch/Disital_test3_Stopwatch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Stopwatch_hex_cnt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Stopwatch_hex_cnt.tcl

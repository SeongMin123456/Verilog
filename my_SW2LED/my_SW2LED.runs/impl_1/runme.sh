...
HD_PWD='C:/verilog_lab/my_SW2LED/my_SW2LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_swled.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_swled.tcl -notrace

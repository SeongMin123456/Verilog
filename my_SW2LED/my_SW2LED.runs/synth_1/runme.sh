...
HD_PWD='C:/verilog_lab/my_SW2LED/my_SW2LED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_swled.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_swled.tcl

...
HD_PWD='C:/verilog_lab/my_Yadder1/my_Yadder1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_bitadder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_bitadder.tcl

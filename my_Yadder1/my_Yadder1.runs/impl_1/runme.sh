...
HD_PWD='C:/verilog_lab/my_Yadder1/my_Yadder1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_bitadder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_bitadder.tcl -notrace

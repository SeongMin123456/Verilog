...
--               c:/verilog_lab/zynq_axi_uart_rxtx_final/zynq_axi_uart_rxtx_final.gen/sources_1/bd/axi_uart/ip/axi_uart_my_uart_tx_0_0/axi_uart_my_uart_tx_0_0_sim_netlist.vhdl
...
entity axi_uart_my_uart_tx_0_0_my_uart_tx is
  port (
    TX : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of axi_uart_my_uart_tx_0_0_my_uart_tx : entity is "my_uart_tx";
end axi_uart_my_uart_tx_0_0_my_uart_tx;

architecture STRUCTURE of axi_uart_my_uart_tx_0_0_my_uart_tx is
  ...
  signal \serial[8]_i_5_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \baud_cnt[0]_i_4\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of send_done_i_2 : label is "soft_lutpair0";
  attribute KEEP : string;
  attribute KEEP of send_done_reg : label is "yes";
  attribute SOFT_HLUTNM of \serial[7]_i_2\ : label is "soft_lutpair2";
...
TX_READY_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
\baud_cnt[0]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\serial[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"02"
    )
        port map (
...
\serial[7]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\serial[8]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0FF50CF50CF50CF5"
    )
        port map (
      I0 => AXI_START,
      ...
      I5 => \serial[8]_i_5_n_0\,
      O => \serial[8]_i_3_n_0\
    );
\serial[8]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\serial[8]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
entity axi_uart_my_uart_tx_0_0 is
  ...
  attribute NotValidForBitStream of axi_uart_my_uart_tx_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of axi_uart_my_uart_tx_0_0 : entity is "axi_uart_my_uart_tx_0_0,my_uart_tx,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of axi_uart_my_uart_tx_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of axi_uart_my_uart_tx_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of axi_uart_my_uart_tx_0_0 : entity is "my_uart_tx,Vivado 2023.2";
end axi_uart_my_uart_tx_0_0;

architecture STRUCTURE of axi_uart_my_uart_tx_0_0 is
...
begin
inst: entity work.axi_uart_my_uart_tx_0_0_my_uart_tx
     port map (

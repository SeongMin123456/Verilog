...
HD_PWD='C:/verilog_lab/zynq_axi_uart_rxtx/zynq_axi_uart_rxtx_final/zynq_axi_uart_rxtx_final.runs/axi_uart_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_uart_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_uart_rst_ps7_0_100M_0.tcl

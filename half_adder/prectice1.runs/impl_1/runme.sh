...
HD_PWD='C:/verilog_lab/prectice1/prectice1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log prectice1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source prectice1.tcl -notrace

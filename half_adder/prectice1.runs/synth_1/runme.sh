...
HD_PWD='C:/verilog_lab/prectice1/prectice1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prectice1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prectice1.tcl

...
HD_PWD='C:/verilog_lab/my_comparator/my_comparator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_comparator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_comparator.tcl

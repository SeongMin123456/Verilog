...
HD_PWD='C:/verilog_lab/my_comparator/my_comparator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_comparator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_comparator.tcl -notrace

...
HD_PWD='C:/verilog_lab/cnt_segment/cnt_segment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cnt_segment.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cnt_segment.tcl -notrace

...
HD_PWD='C:/verilog_lab/cnt_segment/cnt_segment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cnt_segment.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cnt_segment.tcl

...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_tx is
  ...
  signal \serial__0\ : STD_LOGIC_VECTOR ( 8 downto 0 );
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_curr_state[0]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \FSM_sequential_curr_state[0]_i_5\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \send_cnt[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \send_cnt[1]_i_1\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \serial[1]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \serial[2]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \serial[3]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \serial[4]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \serial[5]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \serial[6]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \serial[7]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \serial[7]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \serial[7]_i_4\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of shift_done_i_1 : label is "soft_lutpair6";
...
\FSM_sequential_curr_state[0]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\send_cnt[3]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
\serial[1]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1000"
    )
        port map (
...
\serial[2]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1000"
    )
        port map (
...
\serial[3]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1000"
    )
        port map (
...
\serial[4]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1000"
    )
        port map (
...
\serial[5]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1000"
    )
        port map (
...
\serial[6]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1000"
    )
        port map (
...
\serial[7]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\serial[7]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1000"
    )
        port map (

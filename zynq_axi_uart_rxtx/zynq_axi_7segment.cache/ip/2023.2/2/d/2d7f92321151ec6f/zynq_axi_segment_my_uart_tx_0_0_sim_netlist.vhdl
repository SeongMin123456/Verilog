...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_my_uart_tx is
  ...
  signal \curr_state[0]_i_5_n_0\ : STD_LOGIC;
  signal \curr_state[1]_i_1_n_0\ : STD_LOGIC;
  signal next_state : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute MARK_DEBUG of next_state : signal is std.standard.true;
  signal \next_state_inferred__0_i_3_n_0\ : STD_LOGIC;
  signal \next_state_inferred__0_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \serial[8]_i_3\ : label is "soft_lutpair0";
...
\curr_state[0]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"A0E0"
    )
        port map (
...
\next_state_inferred__0_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"D0DDD0DDD0DDD0D0"
        ...
        port map (
      I0 => curr_state(1),
      I1 => \next_state_inferred__0_i_3_n_0\,
      I2 => \next_state_inferred__0_i_4_n_0\,
      I3 => curr_state(0),
      I4 => TX_INST_0_i_1_n_0,
      I5 => \curr_state[0]_i_3_n_0\,
      O => next_state(0)
    );
\next_state_inferred__0_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\next_state_inferred__0_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"D1CC"
    )
        port map (
...
send_done_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"3FFFFFFF00005500"
    )
        port map (
      I0 => send_done_i_2_n_0,
      I1 => \send_cnt[3]_i_3_n_0\,
      I2 => \send_cnt[3]_i_4_n_0\,
      I3 => curr_state(1),
      I4 => curr_state(0),
      I5 => send_done,
      O => send_done_i_1_n_0
...
send_i_3: unisim.vcomponents.LUT6
    generic map(
...
\serial[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AEAAAEAEAEAAAAAA"
        ...
        port map (
      I0 => \serial[1]_i_2_n_0\,
      I1 => curr_state(1),
      I2 => curr_state(0),
      I3 => serial(1),
      I4 => \serial[8]_i_3_n_0\,
      I5 => serial(2),
      O => \p_0_in__0\(1)
    );

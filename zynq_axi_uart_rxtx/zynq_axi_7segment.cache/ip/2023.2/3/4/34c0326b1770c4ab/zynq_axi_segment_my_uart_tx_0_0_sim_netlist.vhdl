...
\curr_state[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\curr_state[0]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\send_cnt[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"333F222200002222"
    )
        port map (
      I0 => AXI_START,
      I1 => curr_state(1),
      I2 => \curr_state[0]_i_5_n_0\,
...
send_done_i_2: unisim.vcomponents.LUT6
    generic map(
...
shift_done_i_2: unisim.vcomponents.LUT6
    generic map(

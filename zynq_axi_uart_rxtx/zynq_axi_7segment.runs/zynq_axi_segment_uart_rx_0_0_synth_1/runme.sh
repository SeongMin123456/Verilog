...
HD_PWD='C:/verilog_lab/zynq_axi_uart_rxtx/zynq_axi_7segment.runs/zynq_axi_segment_uart_rx_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_axi_segment_uart_rx_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_axi_segment_uart_rx_0_0.tcl

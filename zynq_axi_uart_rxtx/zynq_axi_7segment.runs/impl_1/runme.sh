...
HD_PWD='C:/verilog_lab/zynq_axi_uart_rxtx/zynq_axi_7segment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_axi_segment_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_axi_segment_wrapper.tcl -notrace

...
HD_PWD='C:/verilog_lab/DIgital_test_0219/DIgital_test_0219.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CarryOut.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CarryOut.tcl
